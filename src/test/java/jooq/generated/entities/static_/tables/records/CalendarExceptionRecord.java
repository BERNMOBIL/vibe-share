...
public class CalendarExceptionRecord extends UpdatableRecordImpl<CalendarExceptionRecord> implements Record5<Integer, Date, BigDecimal, UUID, Timestamp> {

    private static final long serialVersionUID = -576540385;

    /**
     * Setter for <code>public.calendar_exception.id</code>.
     */
    public CalendarExceptionRecord setId(Integer value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public Row5<Integer, Date, BigDecimal, UUID, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row5<Integer, Date, BigDecimal, UUID, Timestamp> valuesRow() {
     ...
     */
    @Override
    public CalendarExceptionRecord value1(Integer value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public CalendarExceptionRecord values(Integer value1, Date value2, BigDecimal value3, UUID value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CalendarExceptionRecord(Integer id, Date date, BigDecimal type, UUID calendarDate, Timestamp update) {
        super(CalendarException.CALENDAR_EXCEPTION);
