...
public class StopMapper implements Serializable {

    private static final long serialVersionUID = -970211630;

    private final String    gtfsId;
    private final UUID      id;
    private final Timestamp update;

    public StopMapper(StopMapper value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("StopMapper (");
